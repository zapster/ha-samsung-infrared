"""Media player platform for Samsung Infrared integration."""
...
class SamsungIrTvMediaPlayer(
    ...
    def _send_code(self, code: SamsungTVCode) -> None:
        """Send a Samsung TV code."""
        data = SAMSUNG_TV_CODES[code]
        return self._send_command(SamsungCommand(data=data))

    @override
    async def async_turn_on(self) -> None:
        """Turn on the TV."""
        await self._send_code(SamsungTVCode.POWER)
    ...
    async def async_volume_up(self) -> None:
        ...
        await self._send_code(SamsungTVCode.VOLUME_UP)

    @override
    async def async_volume_down(self) -> None:
        """Send volume down command."""
        await self._send_code(SamsungTVCode.VOLUME_DOWN)

    @override
    async def async_mute_volume(self, mute: bool) -> None:
        """Send mute command."""
        await self._send_code(SamsungTVCode.MUTE)

    @override
    async def async_media_next_track(self) -> None:
        """Send channel up command."""
        await self._send_code(SamsungTVCode.CHANNEL_UP)

    @override
    async def async_media_previous_track(self) -> None:
        """Send channel down command."""
        await self._send_code(SamsungTVCode.CHANNEL_DOWN)

    @override
    async def async_media_play(self) -> None:
        """Send play command."""
        await self._send_code(SamsungTVCode.PLAY)

    @override
    async def async_media_pause(self) -> None:
        """Send pause command."""
        await self._send_code(SamsungTVCode.PAUSE)

    @override
    async def async_media_stop(self) -> None:
        """Send stop command."""
        await self._send_code(SamsungTVCode.STOP)
